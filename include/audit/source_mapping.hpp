...
inline constexpr std::array<Mapping, 48> kSourceMap{{
  ...
  {"src/lib/db.ts", "include/persistence/database.hpp", "PORT_BEHAVIOR", "partial"},
  {"src/lib/persistence/repositories/*", "include/persistence/repositories/*", "PORT_BEHAVIOR", "partial"},
  ...
  {"src/lib/crash/stats.ts", "include/ingestion/stats.hpp", "PORT_BEHAVIOR", "pending"},
