...
inline constexpr std::array<Mapping, 48> kSourceMap{{
  ...
  {"src/lib/crash/native-sign.ts", "include/ingestion/signing/native_sign.hpp", "PORT_PROTOCOL", "implemented"},
  ...
  {"src/lib/crash/transport/bcgame-crash-transport.ts", "include/ingestion/native_transport.hpp", "PORT_BEHAVIOR", "implemented"},
  ...
  {"src/lib/notifications/telegram.ts", "include/delivery/telegram/*", "PORT_BEHAVIOR", "implemented"},
