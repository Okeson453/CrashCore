#pragma once
/** ConditionalFrequencyModel — production model wrapper (TE parity surface). */
#include <cmath>
#include <mutex>
#include <string>
#include <vector>
namespace crashcore {
class ConditionalFrequencyModel {
public:
  explicit ConditionalFrequencyModel(double prior=0.5): prior_(prior) {}
