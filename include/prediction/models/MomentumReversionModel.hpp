#pragma once
/** MomentumReversionModel — production model wrapper (TE parity surface). */
#include <cmath>
#include <mutex>
#include <string>
#include <vector>
namespace crashcore {
class MomentumReversionModel {
public:
  explicit MomentumReversionModel(double prior=0.5): prior_(prior) {}
